...
(function ($) {
    ...
    $.fn.speedometer = function ( options ) {
        ...
        {
            console.log('Percentage value is not a number!');
						return false;
        } else {
            ...
            el.setAttribute("id", "speedtest-" + canvas_id);
            ...
            function _animate() {
                ...
                /* rotate based on percentage. */
								ctx.rotate(i*0.0425-0.55);
								//ctx.rotate(i*0.0435-0.53);
            ...
            if (def.animate) {
                ...
                if(def.digitalRoll) digitalGauge.text(def.percentage + def.suffix);
            }
